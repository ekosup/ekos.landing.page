...
import { QuizOverview, QuizSession, QuizResults } from "@/components/quiz";
...
export default function QuizSessionPage() {
 ...
 const startSessionMutation = useMutation({
  ...
  onSuccess: (data) => {
   ...
   if (quizData?.result?.quiz?.time_limit) {
 ...
 useEffect(() => {
  if (user && quizId && quizStarted && !sessionId) {
   startSessionMutation.mutate();
  }
 }, [user, quizId, quizStarted, sessionId, startSessionMutation]);
 ...
 }, [timeLeft, quizStarted, showResults, finishQuizMutation]);
